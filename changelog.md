...
-   **1.0.2 — Enhancing Float Comparison**

    The conformance tests now use a more robust comparison for floating point numbers that matches the requirements of the specification.
